...
<Assembly: ExtensionApplication(GetType(IMPLACAD.MyPlugin))> 
    ...
    Public Class MyPlugin
        ...
        Public Sub Initialize() Implements IExtensionApplication.Initialize
            ...
            Try
                ...
                'oApp.Preferences.Files.
                ''Dim oMg As AutoCAD.AcadMenuGroups = Application.MenuGroups
