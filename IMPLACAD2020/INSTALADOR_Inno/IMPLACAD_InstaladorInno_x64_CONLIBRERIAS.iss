...
#define MyAppName GetStringFileInfo("C:\INSTALL\IMPLACAD\IMPLACAD2020.bundle\IMPLACAD.dll", "ProductName")
#define MyAppNameDir GetStringFileInfo("C:\INSTALL\IMPLACAD\IMPLACAD2020.bundle\IMPLACAD.dll", "ProductName") + ".bundle"
#define MyAppVersion GetFileVersion("C:\INSTALL\IMPLACAD\IMPLACAD2020.bundle\IMPLACAD.dll")
...
[Files]
Source: "C:\INSTALL\{#MyAppName}\{#MyAppName}2020.bundle\*.*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs; Permissions: everyone-full
Source: "C:\INSTALL\{#MyAppName}\{#MyAppName}\*.*"; DestDir: "{#MyAppData}"; Flags: ignoreversion recursesubdirs; Permissions: everyone-full
